...
RSpec.describe StaysController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all stays as @stays" do
      ...
      expect(assigns(:stays)).to eq([stay])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested stay as @stay" do
      ...
      expect(assigns(:stay)).to eq(stay)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new stay as @stay" do
      ...
      expect(assigns(:stay)).to be_a_new(Stay)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created stay as @stay" do
        post :create, params: {stay: valid_attributes}, session: valid_session
        expect(assigns(:stay)).to be_a(Stay)
        expect(assigns(:stay)).to be_persisted
      end

      it "redirects to the created stay" do
        post :create, params: {stay: valid_attributes}, session: valid_session
        expect(response).to redirect_to(Stay.last)
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "redirects to the stay" do
        stay = Stay.create! valid_attributes
        put :update, params: {id: stay.to_param, stay: valid_attributes}, session: valid_session
        expect(response).to redirect_to(stay)
      end
    end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the stays list" do
      stay = Stay.create! valid_attributes
      delete :destroy, params: {id: stay.to_param}, session: valid_session
      expect(response).to redirect_to(stays_url)
    end
  end
